package com.cooeeui.circualreveal.widget;
...
import com.cooeeui.circualreveal.animation.RevealAnimator;
import com.cooeeui.circualreveal.animation.SupportAnimator;
import com.cooeeui.circualreveal.animation.ViewAnimationUtils;
...
public class RevealLinearLayout extends LinearLayout implements RevealAnimator {
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        if (mRunning && child == mRevealInfo.getTarget()) {
            ...
            mRevealPath.reset();
            mRevealPath
                .addCircle(mRevealInfo.centerX, mRevealInfo.centerY, mRadius, Path.Direction.CW);
