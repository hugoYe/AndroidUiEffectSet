...
import com.cooeeui.circualreveal.animation.ViewAnimationUtils.SimpleAnimationListener;
...
public interface RevealAnimator {
    ...
    /**
     * {@link ViewAnimationUtils#createCircularReveal(View, int, int, float, float)} is called it
     * creates new {@link com.cooeeui.circualreveal.animation.RevealAnimator.RevealInfo} and
     * attaches to parent, here is necessary data about animation
     *
    ...
    /**
     * Returns new {@link SupportAnimator} that plays reversed animation of current one
     *
     * This method might be temporary, you should call {@link SupportAnimator#reverse()} instead
     *
